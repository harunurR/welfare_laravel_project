...
<div class="col-12 grid-margin stretch-card">
  <div class="card">
    <div class="card-body">
      <h4 class="card-title">Edit Debit Voucher</h4>
      <form class="forms-sample" method="post" action="{{ route ('drvoucher.update',$dvoucher->id) }}" enctype="multipart/form-data">
      @csrf
      @method('patch')
      <div class="col-sm-12">
        <div class="widget" style="min-height:500px;">
          <div class="widget-content padding">
            ...
            <div class="row">
							<div class="col-12 col-sm-6">
								<div class="form-group ">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="form-control" name="voucher_no" value="{{old('voucher_no',$dvoucher->voucher_no)}}" readonly>
									</span>
								</div>
							</div>	
							<div class="col-12 col-sm-6">
								<div class="form-group">
									<label>Date</label>
									<input type="date" class="form-control" name="current_date" value="{{old('current_date',$dvoucher->current_date)}}" required>
							...
							<div class="col-12 col-sm-6">
								<div class="form-group">
									<label>Name</label>
									<input type="text" class="form-control" name="pay_name" value="{{old('pay_name',$dvoucher->pay_name)}}">
								</div>
							</div>
							<div class="col-12 col-sm-6">
								<div class="form-group">
									<label>Purpose</label>
									<input type="text" class="form-control" name="purpose" value="{{old('purpose',$dvoucher->purpose)}}">
								</div>
							</div>
							<div class="col-12 col-sm-6">
          ...
          <div class="table-responsive">
							<table class="table table-bordered" id='account' cellspacing="0" width="100%">
									...
									<tfoot>
										<tr>
											...
											<th><input type='text' class='form-control' value='{{$dvoucher->debit_sum}}' style='text-align:center; border:none;' readonly autocomplete="off" /></th>
											<th></th>
										</tr>
										<tr>
                ...
                <div class="row">
                  <div class="col-sm-4 offset-8 text-right">
