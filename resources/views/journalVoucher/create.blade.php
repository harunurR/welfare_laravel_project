...
<div class="col-12 grid-margin stretch-card">
  <div class="card">
    <div class="card-body">
      ...
      <form class="forms-sample" method="post" action="{{ route ('journalVoucher.store') }}" enctype="multipart/form-data">
      @csrf 
      <div class="col-sm-12">
...
<script>
    ...
    function get_head(code){
	    if($(code).val()!=""){
            $.getJSON( "{{route('journal_get_head')}}",{'code':$(code).val()}, function(j){
	            if(j.length>0){
            		var data			= '';
            		var table_name 		= '';
            		var table_id 		= '';
