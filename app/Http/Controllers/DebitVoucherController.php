...
class DebitVoucherController extends Controller
{
    ...
    {
        $dvouchers=DebitVoucher::paginate(10);
        return view('debitvoucher.index',compact('dvouchers'));
    }
    ...
    public function create()
    {
		...
		return view('debitvoucher.create',compact('paymethod'));
    }
    ...
    {
		$dvoucher=DebitVoucher::findOrFail($id);
		$dvoucherbkdn=DevoucherBkdn::where('debit_voucher_id',$id)->get();
		return view('debitvoucher.edit',compact('dvoucher','dvoucherbkdn'));
    }
