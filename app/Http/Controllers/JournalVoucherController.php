...
class JournalVoucherController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('journalVoucher.index',compact('journalVoucher'));
    }
    ...
    public function create()
    {
        ...
        return view('journalVoucher.create',compact('paymethod'));
    }
    ...
    public function store(Request $request){
        try {
            ...
            if(!empty($voucher_no)){
                ...
                DB::commit();
				return redirect(route('journalVoucher.index'));
			}else{
    ...
    public function edit($id)
    {
		...
		return view('journalVoucher.edit',compact('journalVoucher','jvbkdn'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $journalVoucher->save();
        return redirect()->route('journalVoucher.index',compact('journalVoucher'));
    }
